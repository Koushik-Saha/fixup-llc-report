                ...
                {requires2FA ? (
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="text-center mb-4">
                            <p className="text-gray-600">Enter the 6-digit code from your authenticator app, or a backup code.</p>
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                autoFocus
                                placeholder="000000"
                                className="mt-1 block w-full px-4 py-3 bg-white text-gray-900 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-2xl tracking-widest text-center font-mono"
                                value={totpCode}
