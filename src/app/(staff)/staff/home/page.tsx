    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 mt-6">
                <h3 className="text-lg font-semibold mb-4">Today's Report Status</h3>
                {todayReport ? (
                    <div>
                        ...
                        <Link href={`/staff/report/${todayReport.id}`} className="bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 px-4 rounded transition">
                            View Today's Report
                        </Link>
                    </div>
                ) : (
                    <div>
                        ...
                        <Link href="/staff/report/new" className="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded transition">
