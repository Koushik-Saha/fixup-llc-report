            ...
            <div className="bg-white p-4 rounded-lg shadow space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                    ...
                    <div className="flex flex-col justify-end">
                        <button onClick={() => { setStoreId(""); setUserId(""); setSearch(""); setPage(1); }} className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 h-[38px] rounded font-medium">Clear Filters</button>
                    </div>
                </div>
            </div>
