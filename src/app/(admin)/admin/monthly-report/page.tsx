                ...
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 items-stretch sm:items-end w-full sm:w-auto">
                    <div className="w-full sm:w-auto">
                        ...
                        <input
                            ...
                            className="border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 focus:ring-indigo-500 focus:border-indigo-500 w-full sm:w-auto"
                        />
                    </div>

                    <div className="flex bg-slate-100 p-1 rounded-xl gap-1 shrink-0 self-start sm:self-auto">
                        <button
